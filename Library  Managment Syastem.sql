...
INSERT INTO Book_info (Student_id, Student_Name, Book_Name, Book_Number, Issue_Date, Return_Date, Book_Author) VALUES
( "S002","Ankit Sharma","Digital Electronics","BS120",10-08-2024,10-09-2024,'Jane Smith'),
("S004",'Neha Verma',"Data Science","DS178",13-06-2024,12-07-2024,'John Doe');
Select * from Book_info;
...
UPDATE Book_info
SET Return_Date = '2024-08-10'
WHERE Book_Number = 'B001';

select * from Book_info
where student_id="S001";

SELECT Student_info.*, Book_info.*
FROM Student_info
LEFT JOIN Book_info
ON Student_info.Student_id = Book_info.Student_id
WHERE Student_info.Student_id = 'S001';
